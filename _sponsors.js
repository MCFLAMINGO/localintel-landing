...
(function () {
  ...
  function addStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = [
      'footer{width:100%;box-sizing:border-box;position:static;margin-top:0;}',
      ...
      'box-sizing:border-box;width:100%;position:static;',
      '}',
      '.li-sponsors-label{',
      ...
      'object-fit:contain;display:block;flex-shrink:0;max-width:none;',
      '}',
